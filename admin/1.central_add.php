        ...
        <div class="main">
            ...
            <main class="content px-3 py-2">
                <div class="container-fluid">
                    <div class="mb-3">
                        <h4>Central Supply Office Dashboard</h4>
                    </div>
                                ...
                                <div class="text-center mb-4">
                                    ...
                                    if (isset($_POST['save'])) {
                                        ...
                                        if (empty($product_name) || empty($product_num) || empty($unit_of_issue) || empty($batch_num) || empty($exp_date) || empty($unit_value) || empty($onhand) || empty($stock_bal)) {
                                            ...
                                            $insert_query = "INSERT INTO central_supply_office (product_name, product_num, unit_of_issue, batch_num, `exp.date`, unit_value, onhand, stock_bal) 

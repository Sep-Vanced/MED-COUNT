...
$sql = "SELECT * FROM supply_requests WHERE status = 'deleted' AND (product_name LIKE ? OR product_num LIKE ? OR unit_of_issue LIKE ? OR batch_num LIKE ? OR `exp.date` LIKE ?) ORDER BY product_name ASC";

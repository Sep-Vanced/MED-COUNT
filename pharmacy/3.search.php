...
$sql = "SELECT * FROM supply_requests WHERE types = 'pharmacy' AND status = 'rejected' AND (product_name LIKE ? OR requested_quantity LIKE ? OR unit_of_issue LIKE ? OR request_date LIKE ?) ORDER BY product_name ASC";

...
$sql = "SELECT * FROM used_items WHERE user = 'central_supply_office' AND (product_name LIKE ? OR used_quantity LIKE ? OR unit_of_issue LIKE ? OR used_date LIKE ?) ORDER BY product_name ASC";

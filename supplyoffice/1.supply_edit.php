                                ...
                                <div class="text-center mb-4">
                                    ...
                                    include("../config/config.php");
                                        ...
                                        if (isset($_POST['update'])) {
                                            ...
                                            // Process file upload
                                            $new_filename = $row['image_filename']; // Default to old filename
                                            if (!empty($_FILES['product_image']['name'])) {
                                                ...
                                                if (in_array(strtolower($file_ext), $allowed_ext)) {
                                                    ...
                                                    if (move_uploaded_file($_FILES['product_image']['tmp_name'], $upload_path)) {
                                                        // Delete old image file if new image uploaded successfully
                                                        if (!empty($row['image_filename'])) {
                                                            unlink('../image/' . $row['image_filename']);
                                                        }
                                                    } else {
                                            ...
                                            $update_sql = "UPDATE supply_office SET 
                                                ...
                                                image_filename='" . mysqli_real_escape_string($conn, $new_filename). "'
                                                WHERE id = $id";
                                        ...
                                        <div class="column">
                                            ...
                                            <div class="col">
                                                ...
                                                <?php if (!empty($row['image_filename'])): ?>
                                                    <img src="../image/<?php echo $row['image_filename']; ?>" alt="Product Image" style="width: 100px; height: auto;">
                                                <?php endif; ?>
                                            </div>
                                            <div class="mt-3">

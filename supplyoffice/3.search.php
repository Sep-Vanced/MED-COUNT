...
$sql = "SELECT * FROM supply_requests WHERE status = 'rejected' AND (product_name LIKE ? OR requested_quantity LIKE ? OR unit_of_issue LIKE ? OR request_date LIKE ?) ORDER BY product_name ASC";

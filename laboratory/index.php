            ...
            <main class="content px-3 py-2">
                ...
                <div class="tab_item card border-0" id="tab_7" style="display: none;">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex align-items-center mb-3" style="background-color: green; color: #fff; padding: 10px;border-radius: px; font-weight: bold;">
                        ...
                        <div class="card-body">
                            ...
                            <table id="deliveredTable" class="table table-hover text-center">
                                ...
                                <tbody>
                                    ...
                                    $delivered_sql = "SELECT *, DATE_FORMAT(delivery_date, '%Y-%m-%d %H:%i') as formatted_date FROM deliveries WHERE target_office = 'laboratory' ORDER BY delivery_date DESC";
                        ...
                        <div class="card-body">
                            ...
                            <table id="rejectedTable" class="table table-hover text-center">
                                ...
                                <tbody>
                                    ...
                                    $sql = "SELECT *, DATE_FORMAT(request_date, '%Y-%m-%d %H:%i') as formatted_date FROM supply_requests WHERE status = 'Rejected' AND types = 'laboratory' ORDER BY request_date ASC";
                                    if (isset($_GET['from_date']) && isset($_GET['to_date'])) {
                                        $from_date = $_GET['from_date'];
                                        $to_date = $_GET['to_date'];
                                        $sql .= " AND request_date BETWEEN '$from_date' AND '$to_date'";
                                    ...
                                    <div class="modal-dialog">
                                        ...
                                        <form id="pdfForm" action="generate_pdf.php" method="POST" target="_blank">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <?php
                                                    $items_sql = "SELECT DISTINCT product_name FROM used_items WHERE user = 'laboratory'";
                        ...
                        <div class="card-body">
                            ...
                            <table id="usedTable" class="table table-hover text-center">
                                ...
                                <?php
                                    ...
                                    $used_sql = "SELECT product_name, used_quantity, unit_of_issue, DATE_FORMAT(used_date, '%Y-%m-%d %H:%i') as formatted_date FROM used_items WHERE user = 'laboratory' ORDER BY used_date DESC";
                        ...
                        <div class="card-body">
                            ...
                            <table id="supplyRecycleBinTable" class="table table-hover text-center">
                                ...
                                <tbody>
                                    ...
                                    $sql = "SELECT * FROM laboratory WHERE status = 'Deleted'";
